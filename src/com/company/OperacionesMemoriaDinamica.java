...
public class OperacionesMemoriaDinamica implements OperacionesCRM {
    ...
    public List<Pelicula> Crear_nueva_pelicula(List<Pelicula> lista) {
        ...
        String productora;
        Graduaciones.ERecomendaciones recomendaciones;
        String enumerado;
            ...
            case "3":
                ...
                switch (enumerado) {
                    case "todas_las_edades":
                        recomendaciones = Graduaciones.ERecomendaciones.TODAS_LAS_EDADES;
                        break;
                    case "mayores_de_12":
                        recomendaciones = Graduaciones.ERecomendaciones.MAYORES_DE_12;
                        break;
                    case "mayores_de_18":
                        recomendaciones = Graduaciones.ERecomendaciones.MAYORES_DE_18;
                        break;
                    default:
                        recomendaciones = Graduaciones.ERecomendaciones.MAYORES_DE_18;
                        break;
